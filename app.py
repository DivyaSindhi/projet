...
movies_dict = pickle.load(open("C:/Users/divya/OneDrive/Documents/GitHub/movie_dict.pkl", 'rb'))
movies = pd.DataFrame(movies_dict)




similarity = pickle.load(open("C:/Users/divya/Downloads/similarity.pkl", 'rb'))
